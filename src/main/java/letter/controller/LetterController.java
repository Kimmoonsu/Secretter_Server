...
//		System.out.println("letter_id : " + letter_id);
		letterPush(letter_id, "1061337893942895", "김문성","1035494069897172", "Moonsu Kim", "도봉산", "37.6861796", "127.046731", "굿모닝", "APA91bGwGT5rBuEdG82W0aXVJbQIxY8rft-unI4d8vhH2U0lBr-_LMNZ_5lzMlt1Leiu7PHR_OvpWvftHL80SSVT3jeM6rIbUIVDKtlrJAoorn1tpdz63FcG44PwIZCiKEKwDI_Naaxj-bRSTlYgyRdyTR3kYBSCaA");
	}
...
//		double latitude = Double.parseDouble((String)list.get(0).get("latitude"));
//		double longitude = Double.parseDouble((String)list.get(0).get("longitude"));
//		System.out.println("latitude : " + latitude + " longitude : " + longitude);
//		double distance = getDistance(latitude, longitude, 37.504479, 127.04894100000001);
		mv.addObject("List", list);
		return mv;
	}
	...
	public void letterInput(HttpServletRequest request, Map<String, Object> commandMap) throws Exception {
		...
		letterPush(letter_id, to_id, to_name, from_id, from_name, address, latitude, longitude, content, register_id);
	}

	public void letterPush(String letter_id, String to_id, String to_name, String from_id, String from_name, String address, String latitude, String longitude, String content, String register_id)
	{
		...
		.addData("letter_id",letter_id)
		.addData("msg","new 씨그레터 !!!")
		.addData("to_id",to_id)
		.addData("to_name",to_name)
		.addData("from_id",from_id)
